...
const NavigationBar = () => {
  return (
    <div className='fixed w-full bg-[#090909] z-[999]'>
      <header className=' text-[#f5f0ec] flex items-center justify-between px-12 h-24 border-b-[2px] border-b-[#111]'>
        ...
        <nav className=''>
          <ul className='flex items-center gap-3 text-xl font-Syne text-[#555]'>
            <li ><a href="" className='navigation__links hover:text-[#222]'>LinkedIn</a></li>
            ...
            <li><a href="" className='navigation__links hover:text-[#222]'>Work</a></li>
          </ul>
        </nav>
      </header>
      <Motion />
